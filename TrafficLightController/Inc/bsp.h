...
// exported macros
#define RED_ON()          HAL_GPIO_WritePin(RED_GPIO_Port, RED_Pin, GPIO_PIN_SET)
#define RED_OFF()         HAL_GPIO_WritePin(RED_GPIO_Port, RED_Pin, GPIO_PIN_RESET)
#define GREEN_ON()        HAL_GPIO_WritePin(GREEN_GPIO_Port, GREEN_Pin, GPIO_PIN_SET)
#define GREEN_OFF()       HAL_GPIO_WritePin(GREEN_GPIO_Port, GREEN_Pin, GPIO_PIN_RESET)
#define YELLOW_ON()       HAL_GPIO_WritePin(YELLOW_GPIO_Port, YELLOW_Pin, GPIO_PIN_SET)
#define YELLOW_OFF()      HAL_GPIO_WritePin(YELLOW_GPIO_Port, YELLOW_Pin, GPIO_PIN_RESET)
